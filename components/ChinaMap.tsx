      ...
      series: [
        {
          ...
          data: effectData,
          symbolSize: (val: number[]) => Math.max(5, 3 + (val[2] || 0) * 2),
          showEffectOn: 'render',
          rippleEffect: { brushType: 'stroke', scale: 1, period: 3 },
          label: { show: true, formatter: '{b}', position: 'right', color: '#00e5ff', fontSize: 11, fontWeight: 500, textShadowColor: '#000', textShadowBlur: 4 },
          itemStyle: { color: '#00e5ff', shadowBlur: 8, shadowColor: 'rgba(0, 229, 255, 0.5)' },
          zlevel: 2,
        },
        {
          name: '城市',
